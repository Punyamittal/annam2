      ...
      >
        ...
        {Array.from({ length: specs.lateralRoots }).map((_, index) => {
          ...
          return (
            <div
              key={`lateral-${index}`}
              className="absolute bg-amber-600 rounded-full transition-all duration-1000"
              style={{
                height: `${length}px`,
        ...
        {(cropName === 'cereals' || cropName === 'rice') && specs.fibrousRoots > 0 && 
          Array.from({ length: specs.fibrousRoots }).map((_, index) => {
            ...
            return (
              <div
                key={`fibrous-${index}`}
                className="absolute bg-amber-500 rounded-full transition-all duration-1000"
                style={{
                  height: `${length}px`,
                  width: '0.5px',
                  top: `${depth}px`,
        ...
        {specs.rootDensity > 0 && Array.from({ length: Math.min(specs.rootDensity, 50) }).map((_, index) => {
          ...
          return (
            <div
              key={`root-hair-${index}`}
              className="absolute bg-yellow-600 rounded-full opacity-60 transition-all duration-1000"
              style={{
                height: '2px',
                width: '0.3px',
                top: `${depth}px`,
